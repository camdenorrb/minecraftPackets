...
func clientBound() common.PacketRegistry {
	...
	registry.Register(common.ConfigurationState, 0x06, string(common.ClientBoundConfigurationRemResourcePack))
	registry.Register(common.ConfigurationState, 0x07, string(common.ClientBoundConfigurationAddResourcePack))
	registry.Register(common.ConfigurationState, 0x08, string(common.ClientBoundConfigurationFeatureFlags))
	registry.Register(common.ConfigurationState, 0x09, string(common.ClientBoundConfigurationUpdateTags))
	...
	registry.Register(common.PlayState, 0x44, string(common.ClientBoundPlayResetScore))
	registry.Register(common.PlayState, 0x45, string(common.ClientBoundPlayRemoveResourcePack))
	registry.Register(common.PlayState, 0x46, string(common.ClientBoundPlaySetHeadRotation))
	registry.Register(common.PlayState, 0x47, string(common.ClientBoundPlayUpdateSectionBlocks))
	registry.Register(common.PlayState, 0x48, string(common.ClientBoundPlaySelectAdvancementTab))
	registry.Register(common.PlayState, 0x49, string(common.ClientBoundPlayServerData))
	registry.Register(common.PlayState, 0x4A, string(common.ClientBoundPlaySetActionBarText))
	registry.Register(common.PlayState, 0x4B, string(common.ClientBoundPlaySetBorderCenter))
	registry.Register(common.PlayState, 0x4C, string(common.ClientBoundPlaySetBorderLerpSize))
	registry.Register(common.PlayState, 0x4D, string(common.ClientBoundPlaySetBorderSize))
	registry.Register(common.PlayState, 0x4E, string(common.ClientBoundPlaySetBorderWarningDelay))
	registry.Register(common.PlayState, 0x4F, string(common.ClientBoundPlaySetBorderWarningDistance))
	registry.Register(common.PlayState, 0x50, string(common.ClientBoundPlaySetCamera))
	registry.Register(common.PlayState, 0x51, string(common.ClientBoundPlaySetHeldItem))
	registry.Register(common.PlayState, 0x52, string(common.ClientBoundPlaySetCenterChunk))
	registry.Register(common.PlayState, 0x53, string(common.ClientBoundPlaySetRenderDistance))
	registry.Register(common.PlayState, 0x54, string(common.ClientBoundPlaySetDefaultSpawnPosition))
	registry.Register(common.PlayState, 0x55, string(common.ClientBoundPlayDisplayObjective))
	registry.Register(common.PlayState, 0x56, string(common.ClientBoundPlaySetEntityMetadata))
	registry.Register(common.PlayState, 0x57, string(common.ClientBoundPlayLinkEntities))
	registry.Register(common.PlayState, 0x58, string(common.ClientBoundPlaySetEntityVelocity))
	registry.Register(common.PlayState, 0x59, string(common.ClientBoundPlaySetEquipment))
	registry.Register(common.PlayState, 0x5A, string(common.ClientBoundPlaySetExperience))
	registry.Register(common.PlayState, 0x5B, string(common.ClientBoundPlaySetHealth))
	registry.Register(common.PlayState, 0x5C, string(common.ClientBoundPlayUpdateObjectives))
	registry.Register(common.PlayState, 0x5D, string(common.ClientBoundPlaySetPassengers))
	registry.Register(common.PlayState, 0x5E, string(common.ClientBoundPlayUpdateTeams))
	registry.Register(common.PlayState, 0x5F, string(common.ClientBoundPlayUpdateScore))
	registry.Register(common.PlayState, 0x60, string(common.ClientBoundPlaySetSimulationDistance))
	registry.Register(common.PlayState, 0x61, string(common.ClientBoundPlaySetSubtitleText))
	registry.Register(common.PlayState, 0x62, string(common.ClientBoundPlayUpdateTime))
	registry.Register(common.PlayState, 0x63, string(common.ClientBoundPlaySetTitleText))
	registry.Register(common.PlayState, 0x64, string(common.ClientBoundPlaySetTitleAnimationTimes))
	registry.Register(common.PlayState, 0x65, string(common.ClientBoundPlayEntitySoundEffect))
	registry.Register(common.PlayState, 0x66, string(common.ClientBoundPlaySoundEffect))
	registry.Register(common.PlayState, 0x67, string(common.ClientBoundPlayStartConfiguration))
	registry.Register(common.PlayState, 0x68, string(common.ClientBoundPlayStopSound))
	registry.Register(common.PlayState, 0x69, string(common.ClientBoundPlaySystemChatMessage))
	registry.Register(common.PlayState, 0x6A, string(common.ClientBoundPlaySetTabListHeaderAndFooter))
	registry.Register(common.PlayState, 0x6B, string(common.ClientBoundPlayTagQueryResponse))
	registry.Register(common.PlayState, 0x6C, string(common.ClientBoundPlayPickupItem))
	registry.Register(common.PlayState, 0x6D, string(common.ClientBoundPlayTeleportEntity))
	registry.Register(common.PlayState, 0x6E, string(common.ClientBoundPlaySetTickingState))
	registry.Register(common.PlayState, 0x6F, string(common.ClientBoundPlayStepTick))
	registry.Register(common.PlayState, 0x70, string(common.ClientBoundPlayUpdateAdvancements))
	registry.Register(common.PlayState, 0x71, string(common.ClientBoundPlayUpdateAttributes))
	registry.Register(common.PlayState, 0x72, string(common.ClientBoundPlayEntityEffect))
	registry.Register(common.PlayState, 0x73, string(common.ClientBoundPlayUpdateRecipes))
	registry.Register(common.PlayState, 0x74, string(common.ClientBoundPlayUpdateTags))
...
func serverBound() common.PacketRegistry {
	...
	registry.Register(common.PlayState, 0x0F, string(common.ServerBoundPlayChangeContainerSlotState))
	registry.Register(common.PlayState, 0x10, string(common.ServerBoundPlayPluginMessage))
	registry.Register(common.PlayState, 0x11, string(common.ServerBoundPlayEditBook))
	registry.Register(common.PlayState, 0x12, string(common.ServerBoundPlayQueryEntityTag))
	registry.Register(common.PlayState, 0x13, string(common.ServerBoundPlayInteractEntity))
	registry.Register(common.PlayState, 0x14, string(common.ServerBoundPlayJigsawGenerate))
	registry.Register(common.PlayState, 0x15, string(common.ServerBoundPlayKeepAlive))
	registry.Register(common.PlayState, 0x16, string(common.ServerBoundPlayLockDifficulty))
	registry.Register(common.PlayState, 0x17, string(common.ServerBoundPlaySetPlayerPosition))
	registry.Register(common.PlayState, 0x18, string(common.ServerBoundPlaySetPlayerPositionAndRotation))
	registry.Register(common.PlayState, 0x19, string(common.ServerBoundPlaySetPlayerRotation))
	registry.Register(common.PlayState, 0x1A, string(common.ServerBoundPlaySetPlayerOnGround))
	registry.Register(common.PlayState, 0x1B, string(common.ServerBoundPlayMoveVehicle))
	registry.Register(common.PlayState, 0x1C, string(common.ServerBoundPlayPaddleBoat))
	registry.Register(common.PlayState, 0x1D, string(common.ServerBoundPlayPickItem))
	registry.Register(common.PlayState, 0x1E, string(common.ServerBoundPlayPingRequest))
	registry.Register(common.PlayState, 0x1F, string(common.ServerBoundPlayPlaceRecipe))
	registry.Register(common.PlayState, 0x20, string(common.ServerBoundPlayPlayerAbilities))
	registry.Register(common.PlayState, 0x21, string(common.ServerBoundPlayPlayerAction))
	registry.Register(common.PlayState, 0x22, string(common.ServerBoundPlayPlayerCommand))
	registry.Register(common.PlayState, 0x23, string(common.ServerBoundPlayPlayerInput))
	registry.Register(common.PlayState, 0x24, string(common.ServerBoundPlayPong))
	registry.Register(common.PlayState, 0x25, string(common.ServerBoundPlayChangeRecipeBookSettings))
	registry.Register(common.PlayState, 0x26, string(common.ServerBoundPlaySetSeenRecipe))
	registry.Register(common.PlayState, 0x27, string(common.ServerBoundPlayRenameItem))
	registry.Register(common.PlayState, 0x28, string(common.ServerBoundPlayResourcePack))
	registry.Register(common.PlayState, 0x29, string(common.ServerBoundPlaySeenAdvancements))
	registry.Register(common.PlayState, 0x2A, string(common.ServerBoundPlaySelectTrade))
	registry.Register(common.PlayState, 0x2B, string(common.ServerBoundPlaySetBeaconEffect))
	registry.Register(common.PlayState, 0x2C, string(common.ServerBoundPlaySetHeldItem))
	registry.Register(common.PlayState, 0x2D, string(common.ServerBoundPlayProgramCommandBlock))
	registry.Register(common.PlayState, 0x2E, string(common.ServerBoundPlayProgramCommandBlockMinecart))
	registry.Register(common.PlayState, 0x2F, string(common.ServerBoundPlaySetCreativeModeSlot))
	registry.Register(common.PlayState, 0x30, string(common.ServerBoundPlayProgramJigsawBlock))
	registry.Register(common.PlayState, 0x31, string(common.ServerBoundPlayProgramStructureBlock))
	registry.Register(common.PlayState, 0x32, string(common.ServerBoundPlayUpdateSign))
	registry.Register(common.PlayState, 0x33, string(common.ServerBoundPlaySwingArm))
	registry.Register(common.PlayState, 0x34, string(common.ServerBoundPlayTeleportToEntity))
	registry.Register(common.PlayState, 0x35, string(common.ServerBoundPlayUseItemOn))
	registry.Register(common.PlayState, 0x36, string(common.ServerBoundPlayUseItem))
